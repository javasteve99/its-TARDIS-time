...
$(document).ready(function(){
  ...
  images[0]="images/desert.jpg";
  images[1]="images/beach.jpg";
  images[2]="images/highway.jpg";
  images[3]="images/meadow.jpg";
  images[4]="images/square.jpg";
  images[5]="images/street.jpg";
  images[6]="images/woods.jpg";

  var randomImage = images[Math.floor(Math.random() * images.length)];

  $("body").anystretch(randomImage, {centeredX: true});
});
